...
def main(cfg_path: Path, model_path: Optional[Path] = None):
    ...
    cfg["logging"]["log_dir"] += f"_water_aug_{ts}"
    ...
    print("开始增强训练，日志目录", cfg["logging"]["log_dir"])
    trainer.train(train_loader, val_loader)

if __name__ == "__main__":
    ap = argparse.ArgumentParser(description="Water Quality Tabular Augmented Training")
